...
li a span {
  color:  #000000;
                ...
                <div class="row">
                    <div class="col-12 col-md-6 col-lg-6">
                        <div><i class="fas fa-paper-plane"></i> Send Amount</div>
                        <div class="input-group">
                                                                                
                            <div class="f-group">
                                <select class="f-control f-dropdown" placeholder="Select any Send Method ">
                               
                                <option value="1" data-image="images/paymentMethod/amapay.jpeg">Amazon Pay</option>
                    ...
                    <div class="col-12 col-md-6 col-lg-6">
                        <div>Receive Amount <i class="fas fa-reply"></i></div>
                        <div class="input-group">

                            <div class="f-group">
                                <select class="f-control f-dropdown" placeholder="Select any Receive Method ">
                                <option value="1" data-image="images/paymentMethod/nogod.png">Nagad Bangladesh</option>
                                <option value="3" data-image="images/paymentMethod/rocket.png">Rocket Bangladesh</option>
                                <option value="4" data-image="images/paymentMethod/phonepay-removebg-preview.png">Phone Pay</option>
                                <option value="5" data-image="https://bdexchangeworld.com/images/offer/7e88a653f5810ee5196f1e889a913ec6discount.png">Other Payment</option>
                                </select>
        ...
        <button class="btn btn-md" style="background-color: black; color: white;border-radius: 10px;" id="exchange" ><i class="fas fa-exchange-alt exchange-icon"></i> Exchange</button>
