        ...
        <div class="me-contact ">
            <div class="container">
                ...
                <div class="row" style="margin-bottom: 150px;">
                                    ...
                                    <p class=" text-center" style="font-weight: 900; font-size: large; padding-top:9px">
                                    ...
                                    <div class="col-12 mt-3" style="border: 1px solid rgb(176, 170, 170); border-radius: 10px; padding: 25px;">

                                    <p class=" text-center" style="font-weight: 900; font-size: large;">
                                        আমরা সমস্ত ভারতীয় অনলাইন এবং ব্যাংক লেনদেনের পদ্ধতি গ্রহণ করি, যেমন Paytm, UPI, PhonePe এবং আরও অনেক কিছু। আপনি ডিজিটাল ওয়ালেট, UPI অ্যাপ, অথবা প্রথাগত ব্যাংকিং চ্যানেল ব্যবহার করতে পছন্দ করুন না কেন, আমরা আপনার জন্য প্রস্তুত। পছন্দসই পেমেন্ট পদ্ধতি ব্যবহার করে সহজ এবং ঝামেলামুক্ত লেনদেন উপভোগ করুন।
                                    </p>

                                    <p class=" text-center" style="font-weight: 900; font-size: large;">
                                            যদি আপনি ম্যানুয়ালভাবে লেনদেন করতে চান, তবে দয়া করে আমাদের WhatsApp-এ যোগাযোগ করুন। অফলাইন পেমেন্টে আপনাকে সহায়তা করার জন্য আমাদের টিম প্রস্তুত।
                                         ...
                                         <a href="https://wa.me/916900582097" style="text-decoration: none;      color: rgb(37, 231, 46);">
                                            ...
                                            <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" style="width: 24px; height: 24px; vertical-align: middle;">
                                                ...
                                                <span style="margin-left: 8px;">WhatsApp নম্বরে যোগাযোগ করুন:  6900582097</span>
                                                </a>
                                            ...
                                            <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" style="width: 24px; height: 24px; vertical-align: middle;">
                                                ...
                                                <span style="margin-left: 8px;">WhatsApp নম্বরে যোগাযোগ করুন:  9085213136</span>
                                                </a>
                                        </p>
                                    </div>
