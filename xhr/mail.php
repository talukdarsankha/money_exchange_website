...
session_start();
   ...
   if(isset($_POST['email'])){
    ...
    $to = 'bdexchangeworld@gmail.com';
    $from = $email;
    $subject = $subject;
    // $message = "<h2>Mail Received!</h2>";
    $message .=" My Name is: ". $name. "My Contact Details are as follows Email :". $email." and my message is :".$message. "<br>Please Consider me as a BdExchange website User";
